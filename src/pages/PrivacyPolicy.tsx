...
export const PrivacyPolicy = () => {
    return (
        <div className="bg-appleBlack text-white antialiased min-h-screen flex flex-col selection:bg-gold-400 selection:text-black font-sans">
            {/* Styles for glassmorphism and custom scrollbar */}
            <style>{`
                .glass-nav {
                ...
                <div className="max-w-5xl mx-auto px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex-shrink-0 flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-gold-300 to-gold-500 flex items-center justify-center shadow-lg shadow-gold-400/20">
                                <ShieldCheck className="text-black w-5 h-5" />
                            </div>
                            <span className="text-lg font-semibold tracking-tight text-white">STAR <span className="text-gold-400">TECH</span></span>
                        </div>
            ...
            <main className="flex-grow pt-32 pb-20 px-4 sm:px-6 relative overflow-hidden">
                {/* Background Glow FX */}
                <div className="absolute top-0 left-0 right-0 h-[800px] bg-subtle-glow pointer-events-none"></div>

                <div className="max-w-3xl mx-auto relative z-10">
                    {/* Header do Documento */}
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center px-3 py-1 rounded-full border border-gold-400/30 bg-gold-400/10 text-gold-400 text-xs font-medium mb-6 uppercase tracking-wider">
                            Jurídico & Compliance
                        </div>
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-white">
                            Política de Privacidade
                        </h1>
                        <p className="text-lg text-appleLightGray max-w-xl mx-auto">
                    ...
                    <div className="glass-panel rounded-3xl p-8 md:p-12">
                        <div className="prose-custom">
                            ...
                            <p className="text-sm italic border-l-2 border-gold-400 pl-4 py-2 bg-white/5 rounded-r-lg">
                            ...
                            <ol className="list-decimal marker:text-gold-400">
                            ...
                            <ol className="list-decimal marker:text-gold-400">
                                <li>Envie um e-mail para <a href="mailto:cainaestrela777@gmail.com" className="text-gold-400 hover:underline">cainaestrela777@gmail.com</a> com o assunto "Exclusão de Dados".</li>
            ...
            <footer className="bg-black border-t border-white/10 py-12">
                <div className="max-w-5xl mx-auto px-6 text-center">
                    <p className="text-appleLightGray text-xs mb-4">
